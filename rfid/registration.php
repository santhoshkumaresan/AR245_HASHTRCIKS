...
<html>
	<head>
		...
		ul.topnav li {float: left; width:33.3%;}
		...
		ul.topnav li a:hover:not(.active) {background-color: #094099;}
	...
	<body>
		...
		<ul class="topnav">
			...
			<li><a href="user data.php">RFID Database</a></li>
			<li><a class="active" href="registration.php">Register RFID Tag</a></li>
	
			<li><a href="../navbar/index.php">Back to Dashboard</a></li>
		</ul>
