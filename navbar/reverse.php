...
session_start();
 ...
 $cid=$_SESSION["companyid"];
  ...
  //  echo $address ,$gst,$email,$phone,$cn,$ccn,$cid ;
      
        
    $sql = "insert into `reverse` (companyid,rfrom,rto,rload,trucktype,rdate,rtime,remarks) values ('$cid','$from','$to','$load','$trucktype','$rdate','$time','$remarks')"; 
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" name="from" class="form-control" id="exampleInputName" placeholder="Enter Pickup Address" required="required">
          </div>
          <div class="form-group">
            <label for="exampleInputName">To</label>
            <input type="text" name="to" class="form-control" id="exampleInputName" placeholder="Enter Destination Address" required="required">
          </div>
          
        
          <div class="form-group">
            <label for="exampleInputName">Load</label>
            <input type="text" name="load" class="form-control" id="exampleInputName" placeholder="Enter Load weight" required="required">
          </div>
          
          <div class="form-group">
            <label for="exampleInputName">Truck Type</label>
            <input type="text" name="trucktype" class="form-control" id="exampleInputName" placeholder="Enter Truck Type ">
          </div>
          
           <div class="form-group">
            <label for="exampleInputName">Date</label>
            <input type="date" name="date" class="form-control" id="exampleInputName" placeholder="Enter Date of Pickup" required="required">
            </div>
           <div class="form-group">
            <label for="exampleInputName">Time</label>
            <input type="time" name="time" class="form-control" id="exampleInputName" placeholder="Enter Time of Pickup">
          </div>
          <div class="form-group">
            <label for="exampleInputName">Remarks</label>
            <input type="remarks" name="remarks" class="form-control" id="exampleInputName" placeholder="If any">
          </div>
  ...
  <div class="modal" id="EditModal">
          ...
          <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main">
            <div class="form-group mb-0">
              <div class="input-group input-group-alternative input-group-merge">
                ...
                <input class="form-control" placeholder="Search Requests" type="text">
              </div>
            </div>
    ...
    <div class="header bg-primary pb-6">
      <div class="container-fluid">
        <div class="header-body">
            ...
            <div class="col-lg-6 col-7">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="#">Reverse Logistics</a></li>
          ...
          <a href="#newModal" data-toggle="modal" class="btn btn-sm btn-neutral">Send Request</a>
    ...
    if(mysqli_connect_errno()) {  
        die("Failed to connect with MySQL: ". mysqli_connect_error());  
              ...
              $query = "SELECT * FROM `reverse`where companyid={$_SESSION['companyid']}";
