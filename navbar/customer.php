...
session_start();
 ...
 $cid=$_SESSION["companyid"];
  ...
  //  echo $address ,$gst,$email,$phone,$cn,$ccn,$cid ;
       ...
       $sql = "insert into customer (companyid,name,customercompany,phone,email,address,gst) values ('$cid','$cn','$ccn','$phone','$email','$address','$gst')"; 
  ...
  <div class="modal" id="EditModal">
          ...
          <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main">
            <div class="form-group mb-0">
              <div class="input-group input-group-alternative input-group-merge">
                ...
                <input class="form-control" placeholder="Search Customers" type="text">
              </div>
            </div>
    ...
    <div class="header bg-primary pb-6">
      <div class="container-fluid">
        <div class="header-body">
          ...
          <a href="#newModal" data-toggle="modal" class="btn btn-sm btn-neutral">Add Customer</a>
                ...
                <thead class="thead-light">
                  <tr>
                   <th scope="col" class="sort" data-sort="id">ID</th>
                    ...
                    <th scope="col" class="sort" data-sort="comapany_name">Comapany Name</th>
    ...
    if(mysqli_connect_errno()) {  
        die("Failed to connect with MySQL: ". mysqli_connect_error());  
              ...
              $query = "SELECT * FROM `customer` where companyid={$_SESSION['companyid']}";
